      ...
      <div className="w-full flex flex-col">
        <div className="relative w-full h-[70px] overflow-hidden" style={{ contain: "layout paint" }}>
          <div
            ...
            style={{ scrollbarWidth: "none", WebkitOverflowScrolling: "touch", transform: "translateZ(0)" }}
          >
                  ...
                  >
                    <span
                      ...
                      style={{
                        ...
                        border: isActive ? "1.5px solid rgba(255,215,0,0.55)" : "1.5px solid rgba(255,255,255,0.34)",
                        boxShadow: isActive
                    ...
                    {isDayToday && (
                      <span className="absolute top-1 right-1 z-20 rounded-full" style={{ width: 4, height: 4, background: "#FFD700" }} />
                    )}
