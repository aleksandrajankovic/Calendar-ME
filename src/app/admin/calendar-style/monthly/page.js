    ...
    <>
      <div className="mb-4">
        ...
        <p className="text-sm text-neutral-500">
          Override theme, title, background and position for any specific month.
        </p>
      </div>
        ...
        <div className="space-y-6">
          <AdminTableCard title="Settings by Month">
            <div className="p-4 space-y-5">
              ...
              {/* THEME PER MONTH */}
              <div className="pt-3 border-t border-neutral-100">
                <label className="block text-sm font-medium text-neutral-800 mb-2">Calendar theme (override)</label>
              ...
              {/* TITLE PER MONTH */}
              <div className="pt-3 border-t border-neutral-100">
                <label className="block text-sm font-medium text-neutral-800 mb-3">Calendar title (override)</label>
                <input
              ...
              {/* POSITION PER MONTH */}
              <div className="pt-3 border-t border-neutral-100">
                <label className="block text-sm font-medium text-neutral-800 mb-2">Calendar position (override)</label>
                <div className="flex gap-2 flex-wrap">
                  <button
                    type="button"
